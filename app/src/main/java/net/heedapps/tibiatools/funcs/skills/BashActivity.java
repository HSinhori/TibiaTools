...
public class BashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_bash);
        EditText basic_price = findViewById(R.id.cyclops_toe_price);
        EditText intricate_price = findViewById(R.id.ogre_nose_ring_price);
        EditText powerfull_price = findViewById(R.id.warmaster_wristguards_price);
        TextView low_imbui = findViewById(R.id.low_imbui_bash);
        TextView full_imbui = findViewById(R.id.full_imbui_bash);

...
public class VenomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_venom);
        EditText basic_price = findViewById(R.id.swamp_grass_price);
        EditText intricate_price = findViewById(R.id.poisonous_slime_price);
        EditText powerfull_price = findViewById(R.id.slime_heart_price);
        TextView low_imbui = findViewById(R.id.low_imbui_venom);
        TextView full_imbui = findViewById(R.id.full_imbui_venom);

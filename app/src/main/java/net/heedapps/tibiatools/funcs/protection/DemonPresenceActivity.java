...
public class DemonPresenceActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_demon_presence);

        Button btn_calc_strike = findViewById(R.id.btn_calc_demon_presence);
        EditText basic_price = findViewById(R.id.cultish_robe_price);
        EditText intricate_price = findViewById(R.id.cultish_mask_price);
        EditText powerfull_price = findViewById(R.id.hellspawn_tail_price);
        TextView low_imbui = findViewById(R.id.low_imbui_demon_presence);
        TextView full_imbui = findViewById(R.id.full_imbui_demon_presence);

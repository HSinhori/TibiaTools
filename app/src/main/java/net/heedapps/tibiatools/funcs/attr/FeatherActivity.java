...
public class FeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_feather);
        EditText basic_price = findViewById(R.id.fairy_price);
        EditText intricate_price = findViewById(R.id.bowl_of_myrrh_price);
        EditText powerfull_price = findViewById(R.id.goosebump_price);
        TextView low_imbui = findViewById(R.id.low_imbui_feather);
        TextView full_imbui = findViewById(R.id.full_imbui_feather);

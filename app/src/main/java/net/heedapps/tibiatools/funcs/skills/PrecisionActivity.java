...
public class PrecisionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_precision);
        EditText basic_price = findViewById(R.id.elven_scouting_glass_price);
        EditText intricate_price = findViewById(R.id.elven_hoof_price);
        EditText powerfull_price = findViewById(R.id.metal_spike_price);
        TextView low_imbui = findViewById(R.id.low_imbui_precision);
        TextView full_imbui = findViewById(R.id.full_imbui_precision);

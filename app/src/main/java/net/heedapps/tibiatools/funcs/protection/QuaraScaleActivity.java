...
public class QuaraScaleActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quara_scale);

        Button btn_calc_strike = findViewById(R.id.btn_calc_quara_scale);
        EditText basic_price = findViewById(R.id.winter_wolf_fur_price);
        EditText intricate_price = findViewById(R.id.thick_fur_price);
        EditText powerfull_price = findViewById(R.id.deepling_warts_price);
        TextView low_imbui = findViewById(R.id.low_imbui_quara_scale);
        TextView full_imbui = findViewById(R.id.full_imbui_quara_scale);

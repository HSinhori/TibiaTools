...
public class SwiftnessActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_swiftness);

        Button btn_calc_strike = findViewById(R.id.btn_calc_swiftness);
        EditText basic_price = findViewById(R.id.damselfly_price);
        EditText intricate_price = findViewById(R.id.compass_price);
        EditText powerfull_price = findViewById(R.id.waspoid_price);
        TextView low_imbui = findViewById(R.id.low_imbui_swiftness);
        TextView full_imbui = findViewById(R.id.full_imbui_swiftness);

...
public class VibrancyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vibrancy);

        Button btn_calc_strike = findViewById(R.id.btn_calc_vibrancy);
        EditText basic_price = findViewById(R.id.wereboar_price);
        EditText intricate_price = findViewById(R.id.crystallized_price);
        EditText powerfull_price = findViewById(R.id.quill_price);
        TextView low_imbui = findViewById(R.id.low_imbui_vibrancy);
        TextView full_imbui = findViewById(R.id.full_imbui_vibrancy);
        ImageView crystallized_anger = findViewById(R.id.crystallized_img);
        Glide.with(this)
                .load(R.drawable.crystallized_anger)
                .into(crystallized_anger);

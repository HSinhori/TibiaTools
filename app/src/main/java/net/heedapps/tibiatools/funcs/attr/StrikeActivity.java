...
public class StrikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_strike);
        EditText gold_token = findViewById(R.id.gold_token_price_strike);
        EditText basic_price = findViewById(R.id.protective_price);
        EditText intricate_price = findViewById(R.id.sabretooth_price);
        EditText powerfull_price = findViewById(R.id.vexclaw_price);
        TextView gold_imbui = findViewById(R.id.gold_imbui_strike);
        TextView low_imbui = findViewById(R.id.low_imbui_strike);
        TextView full_imbui = findViewById(R.id.full_imbui_strike);

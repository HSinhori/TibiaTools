package net.heedapps.tibiatools.funcs.skills;
...
public class EpiphanyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_epiphany);

        Button btn_calc_strike = findViewById(R.id.btn_calc_epiphany);
        EditText basic_price = findViewById(R.id.elvish_talisman_price);
        EditText intricate_price = findViewById(R.id.broken_shamanic_staff_price);
        EditText powerfull_price = findViewById(R.id.strand_of_medusa_hair_price);
        TextView low_imbui = findViewById(R.id.low_imbui_epiphany);
        TextView full_imbui = findViewById(R.id.full_imbui_epiphany);

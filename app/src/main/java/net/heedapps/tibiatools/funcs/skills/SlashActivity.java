...
public class SlashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_slash);
        EditText basic_price = findViewById(R.id.lions_mane_price);
        EditText intricate_price = findViewById(R.id.moohtah_shell_price);
        EditText powerfull_price = findViewById(R.id.war_crystal_price);
        TextView low_imbui = findViewById(R.id.low_imbui_slash);
        TextView full_imbui = findViewById(R.id.full_imbui_slash);

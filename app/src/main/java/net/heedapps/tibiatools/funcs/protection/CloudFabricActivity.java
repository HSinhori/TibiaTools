...
public class CloudFabricActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cloud_fabric);

        Button btn_calc_strike = findViewById(R.id.btn_calc_cloud_fabric);
        EditText basic_price = findViewById(R.id.wyvern_talisman_price);
        EditText intricate_price = findViewById(R.id.crawler_head_plating_price);
        EditText powerfull_price = findViewById(R.id.wyrm_scale_price);
        TextView low_imbui = findViewById(R.id.low_imbui_cloud_fabric);
        TextView full_imbui = findViewById(R.id.full_imbui_cloud_fabric);

...
public class ScorchActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scorch);

        Button btn_calc_strike = findViewById(R.id.btn_calc_scorch);
        EditText basic_price = findViewById(R.id.fiery_heart_price);
        EditText intricate_price = findViewById(R.id.green_dragon_scale_price);
        EditText powerfull_price = findViewById(R.id.demon_horn_price);
        TextView low_imbui = findViewById(R.id.low_imbui_scorch);
        TextView full_imbui = findViewById(R.id.full_imbui_scorch);

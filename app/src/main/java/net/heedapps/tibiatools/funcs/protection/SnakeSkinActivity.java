...
public class SnakeSkinActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_snake_skin);

        Button btn_calc_strike = findViewById(R.id.btn_calc_snake_skin);
        EditText basic_price = findViewById(R.id.piece_of_swampling_wood_price);
        EditText intricate_price = findViewById(R.id.snake_skin_price);
        EditText powerfull_price = findViewById(R.id.brimstone_fangs_price);
        TextView low_imbui = findViewById(R.id.low_imbui_snake_skin);
        TextView full_imbui = findViewById(R.id.full_imbui_snake_skin);

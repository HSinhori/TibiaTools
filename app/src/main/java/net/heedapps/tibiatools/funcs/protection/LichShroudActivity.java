package net.heedapps.tibiatools.funcs.protection;
...
public class LichShroudActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lich_shroud);

        Button btn_calc_strike = findViewById(R.id.btn_calc_lich_shroud);
        EditText basic_price = findViewById(R.id.flask_of_embalming_fluid_price);
        EditText intricate_price = findViewById(R.id.gloom_wolf_fur_price);
        EditText powerfull_price = findViewById(R.id.mystical_hourglass_price);
        TextView low_imbui = findViewById(R.id.low_imbui_lich_shroud);
        TextView full_imbui = findViewById(R.id.full_imbui_lich_shroud);

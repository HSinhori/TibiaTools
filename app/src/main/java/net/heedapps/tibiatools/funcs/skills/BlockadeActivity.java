...
public class BlockadeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_blockade);
        EditText basic_price = findViewById(R.id.piece_of_scarab_shell_price);
        EditText intricate_price = findViewById(R.id.brimstone_shell_price);
        EditText powerfull_price = findViewById(R.id.frazzle_skin_price);
        TextView low_imbui = findViewById(R.id.low_imbui_blockade);
        TextView full_imbui = findViewById(R.id.full_imbui_blockade);

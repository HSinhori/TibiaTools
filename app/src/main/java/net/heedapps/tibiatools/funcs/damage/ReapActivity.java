...
public class ReapActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reap);

        Button btn_calc_strike = findViewById(R.id.btn_calc_reap);
        EditText basic_price = findViewById(R.id.pile_of_grave_earth_price);
        EditText intricate_price = findViewById(R.id.demonic_skeletal_hand_price);
        EditText powerfull_price = findViewById(R.id.petrified_scream_price);
        TextView low_imbui = findViewById(R.id.low_imbui_reap);
        TextView full_imbui = findViewById(R.id.full_imbui_reap);

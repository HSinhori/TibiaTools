...
public class ElectrifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_electrify);
        EditText basic_price = findViewById(R.id.rorc_feather_price);
        EditText intricate_price = findViewById(R.id.peacock_feather_fan_price);
        EditText powerfull_price = findViewById(R.id.energy_vein_price);
        TextView low_imbui = findViewById(R.id.low_imbui_electrify);
        TextView full_imbui = findViewById(R.id.full_imbui_electrify);

...
public class DragonHideActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dragon_hide);

        Button btn_calc_strike = findViewById(R.id.btn_calc_dragon_hide);
        EditText basic_price = findViewById(R.id.green_dragon_leather_price);
        EditText intricate_price = findViewById(R.id.blazing_bone_price);
        EditText powerfull_price = findViewById(R.id.draken_sulphur_price);
        TextView low_imbui = findViewById(R.id.low_imbui_dragon_hide);
        TextView full_imbui = findViewById(R.id.full_imbui_dragon_hide);

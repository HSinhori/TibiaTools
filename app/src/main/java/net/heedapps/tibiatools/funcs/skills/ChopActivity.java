...
public class ChopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_calc_strike = findViewById(R.id.btn_calc_chop);
        EditText basic_price = findViewById(R.id.orc_tooth_price);
        EditText intricate_price = findViewById(R.id.battle_stone_price);
        EditText powerfull_price = findViewById(R.id.moohtant_horn_price);
        TextView low_imbui = findViewById(R.id.low_imbui_chop);
        TextView full_imbui = findViewById(R.id.full_imbui_chop);
